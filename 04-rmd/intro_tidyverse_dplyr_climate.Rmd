...
1.  Change CO~2~ yearly data to long format
...
2.  Delete (not select) those variables that you're not interested in <!--brief explanation of pipes-->
...
3.  Create a new variable (column) with mutate to get mean temperature data
...
4.  But wait! We're just interested in yearly data not daily data
...
5.  Join both datasets and review what we have learned so far
