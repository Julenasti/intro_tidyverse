...
1. First I'll select those variable that I know the meaning
...
8. Clearly Pontiac is the best brand!
...
## 7| forcats (solve common problems with factors)
...
2. Tidy data
3. Visualise putting site 1 at the end
