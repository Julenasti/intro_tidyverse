...
```{r tidydata, fig.align = 'center', fig.cap = "by Allison Horst"}
...
```{r tidyverse, fig.align = "center", out.width = "30%"}

knitr::include_graphics(here("04-output", "figures_tidyverse", "02-tidyverse-packages.png"))
...
```{r dplyr, fig.align = "center", out.width = "30%", fig.cap = "by Allison Horst"}

knitr::include_graphics(here("04-output", "figures_tidyverse", "03-dplyr.jpg"))
...
-   Recommended book: [R for Data Science](https://r4ds.had.co.nz/) by Hadley Wickham & Garrett Grolemund (the information in this document is based mainly on this book)
...
1.  Change CO\~2\~ annual data to long format
...
1.  Bind/Join both tmin and tmax data
...
1.  Create a new variable (column) with mutate to get mean temperature data
...
1.  But wait! We're interested in annual data not daily data
...
1.  Join both datasets and review what we have learned so far
...
```{r loop-purrr, fig.align = 'center', fig.cap = "Illustrations from Hadley Wickham's talk "The Joy of Functional Programming (for Data Science)"}

knitr::include_graphics(here("04-output", "figures_tidyverse", "04-forloops.png"))
knitr::include_graphics(here("04-output", "figures_tidyverse", "05-map_frosting.png"))
...
rds_files <- read_all_csv(path = here("01-data"))
