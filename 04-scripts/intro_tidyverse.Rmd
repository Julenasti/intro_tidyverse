...
`r emo::ji("email")` julenastigarraga@gmail.com
...
# see attached packages & conflicts
library(tidyverse)
...
-   pipes (`%>%` & `|>`)
`r emo::ji("magnifying")` [Check out this post by Isabella Velásquez](https://towardsdatascience.com/understanding-the-native-r-pipe-98dea6d8b61b)
